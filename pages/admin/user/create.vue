<template>
  ...
  <div class="mt-8 ml-72">
    <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
      <h2 class="text-xl font-bold tracking-tight text-gray-900 mb-6">당원 추가</h2>
      <div>
        ...
        <div class="w-full px-3 ">
          <div>
            <button type="submit" class="bg-sky-700 text-white text-md shadow-sm rounded-sm px-4 py-2" >등록하기</button>      
