        ...
        <div class="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6">
          <div>
            ...
            <div class="mt-3 text-center sm:mt-5">
              <strong>국민혁명당 개인정보 처리방침</strong><br />
                국민혁명당매체사명 (이하 ‘회사’라 한다)는(은) 개인정보 보호법 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립 · 공개합니다. 회사는 개인정보취급방침을 개정하는 경우 회사 웹사이트 공지사항(또는 개별공지)을 통하여 공지할 것입니다.
                <br /><br />
